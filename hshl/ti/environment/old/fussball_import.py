...
#engine = create_engine('postgresql://postgres:hshl@localhost:5432/postgres')
engine = create_engine('postgresql://hshl:hshl@localhost:5432/hshl')

try:
	print("Erstelle Schema bundesliga...")
	with engine.connect() as con:
		con.execute('create schema bundesliga;')
except Exception as inst:
	print(inst)
	print("Konnte Schema nicht anlegen. Hat es schon existiert?")	
